...
function Home() {
  return (
    ...
    <p className={styles.txtBio}>Una vez licenciada en jazz, Estela accede al Máster en Gestión Empresarial de la Industria Musical de la UNIR y en 2024 publica su primer álbum.</p>
    <p className={styles.txtBio}>Actualmente amplía sus estudios vocales en el Máster de Interpretación Jazz del Liceu y ejerce como profesora de canto y violoncello en la escuela Luthier, en Barcelona, al tiempo que lidera su grupo musical con el que ofrece conciertos de jazz y música de autor en distintas localidades de España.</p>
